label chapter6:
    ...
    "Ringo looks down and notices the shadow beneath her feet begin to flicker again."
    ...
    "Kanna slams directly into Charlotte, knocking her clean off her feet, into the ground."
    ...
    Maya "Here."
    Char "Pick a card there, tender Kyousuke. Memorize it. Commit your mental capacity to fully commit the card before you to memory."
    Kyou "Got it.  Then I put it back in the deck, right?"
    Char "Yes! Now, observe."

    "Charlotte places the deck of cards on the ground. She stomps down hard, keeping her foot on the top of the cards."
    ...
    "Ringo pops out of Kyousuke's backpack, snagging a card out of midair, and handing it to Kyousuke."
