label chapter1:
    ...
    Rin "{i}Gulp... gulp...{/i} Ah! It seems like you've got some competition. Another player in the game to win the boy's heart."
    # Art (Sprite Artist) Ringo wears a hat or glasses
    Kan speaking curious "Huh?"
    Kan smile concerned ec "What's with that getup?"
    Rin "If we want to win the game, we must first understand our opponent."
    Rin "I'm going to do some investigating around school tomorrow."
    Rin "It would be catastrophic if someone were to see me in this form."
    Rin "I'll do my best to stay hidden. This disguise is just for added measure."
    ...
    Rin "Just sneak me into school in your backpack again. I'll handle the investigation from there."
