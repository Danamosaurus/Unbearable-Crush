label chapter3:
    ...
    Kan "How intimate."
    "Ringo floats up behind Kyousuke."

    Rin  "Let's see what we got here."
    "NOTE: SHOW A CHOICE SELECTION CG HERE"
    ##Show a choice selection CG here
    ...
    label choice3_A:
        ...
        "Ringo makes the selection for Kyousuke, then floats back to Kanna to hide in her backpack again. "
        ...
        "Ringo floats over to Kyousuke, claps his hands, rubs them together, and places them on Kyousuke's cheek, healing his sullen face instantly, and waking him up"
    ...
    label choice3_B:
        ...
        Kyou "It's alright Kanna, I'm not that great at math either."
        Kan  "Wha?"
    ...
    Maya  "I’m sorry? Me and Kyousuke will be math partners next period."
    Kan  "Huh?"
    Kyou  "Oh I forgot, Kanna; me and Maya are always math partners."
    Maya  "That's right."
    Kan  "But-"
    ...
    "Ringo floats behind Kyousuke once again."
    ...
    "Ringo looks around, trying to locate the weird sensation he notices."

    "Huh, is there another spirit around?"
    "Doesn't matter, gotta stay focused on the game."

    # CG Display the two choices below.
    "NOTE: INSERT CHOICE SELECTION CG"
    "#Choose Maya as a math partner."
    "#Head to the bathroom."
    "What kind of options are those!? God, he really can't think for himself at all."
    ...
    label choice3_C:
        ...
        Kyou  "Ya know, Maya, Kanna may need more help in math then you do. Maybe I should help her this time. It's the right thing to do."
    ...
    Kan  "Hm, I guess I never considered the existence of other spirits. It makes sense that there’s more than just you, though. Are they all cute little animals?"
