label chapter3:
    ...
    Rin "Ya know, a little push here, a little nudge there, and it'll be all over for Maya and Kyousuke will fall right into your arms."
    Rin "It's what us wingmen do."
    ...
    Rin "I mean, at some point he picks one. But it looks like he's stumped this time."
    Rin "Probably because you yelled at him to shut up."
    Kan "THAT WAS YOUR FAULT!"
    Rin "I'll see what he's thinking and {i}help him{/i} decide the best choice."
...
label ch3choice1option1:
    ...
    Rin  "Next time, instead of unleashing the God hand on the poor kid, try using words first, okay?"
    Kan sad smile "Okay..."
...
label chapter3p2:
    ...
    Maya flirting eo "Kyousuke is the most sophisticated man I have ever met. His intellectual prowess is something someone like you can't comprehend."
    Maya speaking normal "The fact he's wasting his time in this lugubrious school is beyond even my own grasp."
    Maya speaking normal "And I've never received anything less than a perfect score in any of my classes. So, Can-oh, I think I can quite tell someone of the same pedigree as me when I see them."
    ...
    Maya speaking normal "And it's the truth. Kyousuke would never lie about anyone's name."
    ...
    Maya "I’m sorry? Kyousuke will be too busy being my math partner."
    ...
    Kan angry crazy "Is that what you wash it with?"
    ...
    "I sense something. Some kind of presence."
...
label ch3choice2option1:
        ...
        Maya hopeless ec "Kyousuke, your valiance knows no bounds. Have a nice class...{i}Kanna.{/i}"
...
#ART Kanna's room
    ...
    Rin "But don't worry. I think it might have been some of may own magic I was sensing. Magic can sometimes go off and do its own thing."
