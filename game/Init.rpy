...
#Dynamic Sprite System-Each category represents a folder in the Images section. These will be auto-defined.
   ...
   DefineImages('images/sprites', composite=True, overrideLayerOrder=layerorder, offsets=(0, 100), zooms={'Kan':0.5,'Rin':0.5,'Kyou':0.5, 'Maya': 1.3,'Youk':0.5, 'Char':1.3}, sides=['Kan', 'Rin', 'Kyou','Maya','Youk','Char'])
   hide_sides = []
