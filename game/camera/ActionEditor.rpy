        ...
        vbox:
            ...
            hbox:
                ...
                hbox:
                    ...
                    textbutton _("copy to clipboard") action Function(_viewers.put_clipboard)
                hbox:
                    xalign 1.
                        ...
                        if p not in _viewers.transform_viewer.force_float and (p in _viewers.transform_viewer.force_int_range or ((value is None and isinstance(d, int)) or isinstance(value, int))):
                            hbox:
                                ...
                                if p in _viewers.transform_viewer.force_plus:
                                    bar adjustment ui.adjustment(range=_viewers.transform_viewer.int_range, value=value, page=1, changed=f) xalign 1. yalign .5 ysize 10
                                else:
                                    bar adjustment ui.adjustment(range=_viewers.transform_viewer.int_range*2, value=value+_viewers.transform_viewer.int_range, page=1, changed=f) xalign 1. yalign .5 ysize 10
                        else:
                            hbox:
                                style_group "action_editor"
                                ...
                                if p in _viewers.transform_viewer.force_plus:
                                    bar adjustment ui.adjustment(range=_viewers.transform_viewer.float_range, value=value, page=.05, changed=f) xalign 1. yalign .5 ysize 10
                                else:
                                    bar adjustment ui.adjustment(range=_viewers.transform_viewer.float_range*2, value=value+_viewers.transform_viewer.float_range, page=.05, changed=f) xalign 1. yalign .5 ysize 10
            elif tab == "Camera":
