...
screen expbar(name, from_exp, to_exp, duration=2.5, showduration=0.6, align=(0.95, 0.03), yoffset=-100, levelup=0):
    ...
    fixed:
        at healthbar_transform(align=(0.95, 0.03), yoffset=-100, duration=showduration)
        xsize 680
        ysize 50
        hbox:
            spacing 15
